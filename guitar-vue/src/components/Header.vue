                                        ...
                                        <tr v-for="guitarra in carrito" :key="guitarra.id">
                                            ...
                                            <td class="flex align-items-start gap-4">
                                                <button type="button" class="btn btn-dark"
                                                    @click="$emit('descontar-Carrito', guitarra.id)">
                                                    -
                                                </button>
                                                {{ guitarra.cantidad }}
                                                <button type="button" class="btn btn-dark"
                                                    @click="$emit('aumentar-Carrito', guitarra.id)">
                                                    +
                                                </button>
                                            </td>
                                            <td>
                                                <button class="btn btn-danger" type="button"
                                                    @click="$emit('eliminar-Carrito', guitarra.id)">
                                                    X
                                                </button>
                                            </td>
                                        </tr>
            ...
            <div class="row mt-5">
                <div class="col-md-6 text-center text-md-start pt-5">
                    ...
                    <button type="button" class="btn fs-4 bg-primary text-white py-2 px-5"
                        @click="$emit('agregar-Guitarra', guitarra)">Agregar al Carrito</button>
                </div>
            </div>
        </div>
